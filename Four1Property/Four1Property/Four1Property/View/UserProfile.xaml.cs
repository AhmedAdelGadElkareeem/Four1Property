...
namespace Four1Property.View
{
    ...
    public partial class UserProfile : ContentPage
    {
        ...
        public UserProfile(ObservableCollection<Property> properties)
        {
            ...
            if (Application.Current.Properties["Language"].ToString() == "Arabic")
            {
                ...
                {
                    NoProperty.Text = "عقاراتك المعروضة";
                    NoProperty.TextColor = Color.FromHex("#FF071D66");
                    NoProperty.IsVisible = true;
                }
                this.Title = "ملفي";
            ...
            else
            {
                ...
                {
                    NoProperty.Text = "Your Published Properties";
                    NoProperty.TextColor = Color.FromHex("#FF071D66");
                    NoProperty.IsVisible = true;
                }
                this.Title = "Profile";
                    ...
                    ColumnDefinitions =
        {
          ...
          new ColumnDefinition { Width = new GridLength(1, GridUnitType.Star) },
                ...
                wishtap.Tapped += async (sender, e) =>
                {
                    ...
                    await Navigation.PushAsync(new UserProfile(_properties));
                    await Task.Delay(500);
